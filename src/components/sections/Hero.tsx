...
export const Hero = () => {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background com overlay - melhorado para modo claro */}
      ...
      <div className="absolute inset-0 z-10">
        ...
        <div className="absolute top-40 right-32 w-6 h-6 bg-primary/60 rounded-full animate-float" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-32 left-1/4 w-3 h-3 bg-primary rounded-full animate-float" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-20 right-20 w-5 h-5 bg-primary/40 rounded-full animate-float" style={{animationDelay: '0.5s'}}></div>
      </div>
      ...
      <div className="relative z-20 container mx-auto px-6 text-center mt-20">
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary animate-glow">
            ...
            <span className="text-sm font-medium">Agência de Marketing Digital</span>
          </div>
